...
class GetAverageDistanceWithTransfersTest {
	...
	@BeforeAll static void init(){
		...
		for(int j = testSchoolCount/2; j < testSchoolCount; j++, distance += 25) {
	...
	@Test void test() {
		double actualAverageDistance = (double) model.getAverageDistanceWithTransfers();
		
		assertEquals(47.1, actualAverageDistance, .1);
		System.out.println("Actual Distance: " + actualAverageDistance);
	}
